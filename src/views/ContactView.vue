<template>
  <section class="max-w-2xl mx-auto mt-12 px-4 text-center">
    <h2 class="text-3xl font-serif font-bold mb-4 text-gray-900 tracking-tight">
      Contact Us
    </h2>
    <p class="text-lg text-gray-700 mb-6 leading-relaxed">
      Have a question, want to join a club, or just want to connect with the NB
      Armwrestling community? Reach out to us below!
    </p>
    ...
    <div class="flex justify-center gap-6 mt-8 mb-2">
      <a
        href="https://facebook.com/NBArmwrestling"
        target="_blank"
        aria-label="Facebook"
        class="text-[#0055a4] hover:text-[#003366] transition-colors duration-200"
      >
        <svg
      ...
      <a
        href="https://instagram.com/nb_armwrestling"
        target="_blank"
    ...
    <div class="text-gray-500 text-sm mt-2">
      Follow us on social for news, events, and more!
    </div>
  </section>
</template>
